...
* [Ipopt](https://projects.coin-or.org/Ipopt)
  ...
  * Linux
    ...
    * Then call `install_ipopt.sh` with the source directory as the first argument, ex: `bash install_ipopt.sh Ipopt-3.12.8`. Note Actually the Ipopt package is already contained in this repository. There is no need to download from anywhere else.  
